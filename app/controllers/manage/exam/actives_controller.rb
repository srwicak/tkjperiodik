class Manage::Exam::ActivesController < ApplicationController
  ...
  def exam_params
    params.require(:exam).permit(:name, :short_name, :slug, :size, :exam_date_start, :exam_date_end, :status, :notes, :descriptions, :start_register, :allow_onspot_registration, :form_a_police_position, :form_a_event_position, :form_a_name, :form_a_rank, :form_a_nrp)
  end
